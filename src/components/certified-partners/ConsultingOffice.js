...
import ConsultingOfficeList from './ConsultingOfficeList';
// utils
import { notifyToast } from '../modal/ApplyModal';
import { API_URL } from '../../config';

export default function ConsultingOffice() {
    ...
    const getAdvisorList = async () => {
        ...
        try {
            ...
            else notifyToast("error", response.data.msg);
    ...
    return (
        <Box sx={{ display: { xs: "inherit", sm: "flex" } }}>
            <Box sx={{ width: { xs: "100%", sm: "30%" } }}>
                <FilterList whereIn="consulting_office" advisorList={filteredList} originalList={originalList} setUpFilter={setUpFilter} />
            </Box>
            <Box sx={{ width: { xs: "100%", sm: "70%" } }}>
                <ConsultingOfficeList consultingOfficeList={filteredList} />
                {/* <Box component="h1" textAlign="center">Coming Soon</Box> */}
            </Box>
        </Box>
    )
}