    ...
    const TechnicalServiceComponent = ({ isPack, isChanged }) => {
        ...
        const emptyForm = () => {
            ...
            setPhone(""); setOrdernumber(""); setWalletNumber("");
            setReceipt(null); setReceiptName(""); setMessage("");
            setCapchaResult("");
        }

        const validateForm = () => {
            if (fName && lName && username && email && validateEmail(email) &&
                phone && validatePhone(phone) && ordernumber &&
                walletnumber && capchaResult && message && receiptName
            )
                return true;
            else return false;
        }
    ...
    export default TechnicalServiceComponent;